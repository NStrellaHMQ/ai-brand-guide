...
### Light Theme (Default)
Use this for standard decks, diagrams, and clean documentation.
- **White & Light Neutrals (50–70%):** The primary canvas. Ensure high levels of "breathable" white space.
- **HiveMQ Yellow (#FFC000) (10–30%):** Use for key elements, primary nodes in diagrams, or title bars. 
- **Black & Dark Neutrals (10–20%):** Use for text, borders, and structural lines.
- **Teal (#037DA5) (0–10%):** Use strictly for minor accents or specific data callouts.

### Dark Theme 
Use this for high-impact slides, developer-focused content, engaging visuals, or "Dark Mode" UI sketches.
- **Black & Dark Neutrals (50–70%):** The primary canvas. Use deep neutral charcoal or true black.
- **HiveMQ Yellow (#FFC000) (10–30%):** Glows against the dark background. Use for high-visibility highlights.
...
### Body Copy: Roboto
- **Usage:** Bullet points, descriptions, and diagram annotations.
