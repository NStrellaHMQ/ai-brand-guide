...
If user asks for a color outside of the palette, replace with a neutral grey. 
No Clutter: If an element doesn't serve a functional purpose in the graphic, remove it.
